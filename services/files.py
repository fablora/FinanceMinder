...
# Function to download excel report from the ABS with the latest CPI
# Title: Ausdex
# Author: Robert Turnbull
# Date: 7 Feb 2023
# Version: 1.1.2
# Availability: https://github.com/rbturnbull/ausdex/tree/main
...
def get_cached_path(filename: str) -> Path:
    ...
    """
    cache_dir = Path(user_cache_dir("FinanceMinder"))
