...
def create_expense_barchart(categories = None, amounts = None):
    ...
    amounts(list): List of expense amount corresponding to each category
    ...
    try:
        ...
        print(f"Error creating expense bar chart: {e}")
        return go.Figure()
...
def create_expense_piechart(categories = None, amounts = None, percentage = None):
    ...
    categories(list): List of expense categories
    amounts(list): List of expense amount corresponding to each category
    percentage (list): List of expense percentages corresponding to each category
...
def create_expense_trend_chart():
    '''
    Create line chart to show the monthly trend of expenses by category

    Parameters:
    categories(list): List of expense categories
    amounts(list): List of expense amount corresponding to each category
    date (list): List of expense percentages corresponding to each category
